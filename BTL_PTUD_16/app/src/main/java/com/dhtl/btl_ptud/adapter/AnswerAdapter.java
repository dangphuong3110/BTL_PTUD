...
public class AnswerAdapter extends RecyclerView.Adapter<AnswerAdapter.RecyclerViewHolder> {
    ...
    public AnswerAdapter(List<Items> itemsList, Context context) {
    ...
    private void setAnswerUser(Items items, String answerUser) {
        ...
        notifyDataSetChanged(); //Thông báo cho RecyclerAdapter có thay đổi để cập nhật lại
    }
    ...
    public AnswerAdapter.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = inflater.inflate(R.layout.answer_layout, parent, false);
        return new AnswerAdapter.RecyclerViewHolder(itemView);
    }

    @RequiresApi(api = M)
    @Override
    public void onBindViewHolder(AnswerAdapter.RecyclerViewHolder holder, final int position) {
